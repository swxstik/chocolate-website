...
const products = [
  ...
  { id: 40, name: 'MDF Basket', code: 'CW11', weight: '250 gm', image: 'productlistings/mdf_basket.jpg' },
  { id: 41, name: 'Special Delights', weight: '1000 gm+', image: 'productlistings/special_delights.png' },
  { id: 42, name: 'Thaal 1670', code: 'CW26', weight: '1670 gm', image: 'productlistings/thaal_1670.png' },
  { id: 43, name: 'Round basket', code: 'CW9', weight: '250 gm', image: 'productlistings/round_basket.png' },
  { id: 44, name: 'Decorative Bites',  code: 'CW20', weight: '1000 gm+', image: 'productlistings/decorative_bites.png' },
  { id: 45, name: 'Haandi', code: 'CW6', weight: '150 gm', image: 'productlistings/haandi.png' },
  { id: 46, name: 'Flexbox', code: 'CW6', weight: '130 gm', image: 'productlistings/flexbox.png' },
  { id: 47, name: 'Mayur Tray', code: 'CW2', weight: '100 gm', image: 'productlistings/mayur_tray.png' },
  { id: 48, name: 'Oval Basket', code: 'CW9', weight: '250 gm', image: 'productlistings/oval_basket.png' },
  { id: 49, name: 'Plastic Tray 2', code: 'CW8', weight: '250 gm', image: 'productlistings/plastic_tray_2.png' },
  { id: 50, name: 'Paper Mache Round Basket', code: 'CW10', weight: '165 gm', image: 'productlistings/paper_mache.png' },
  { id: 51, name: 'Choco Ladoo Box', weight: '65 gm', image: 'productlistings/choco_ladoo_box.png' },
  { id: 52, name: '4 Piece Box', code: 'CW3', weight: '65 gm', image: 'productlistings/4_pc_box.png' },
